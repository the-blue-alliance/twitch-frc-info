...
const Alliance = styled.div`
  ...
  ${props => !props.isFinals && `${props.rightSide ? 'margin-left' : 'margin-right'}: 0.5vw`};
...
const WinsContainer = styled.div`
  ...
  ${props => props.isFinals && 'padding: 0.5vw;'}
`
...
const PlayoffMatchupAlliance = React.memo(({eventKey, color, seed, wins, winner, rightSide, isFinals}) => {
        ...
        return (
          ...
          >
            ...
            >
              ...
              <Wins>{wins}</Wins>
              <Medal>
                {isFinals && winner && isWinner && <MedalIcon src={GoldMedal} alt='Gold medal'/>}
                {isFinals && winner && !isWinner && <MedalIcon src={SilverMedal} alt='Silver medal'/>}
              </Medal>
            </WinsContainer>
            <TeamContainer>
